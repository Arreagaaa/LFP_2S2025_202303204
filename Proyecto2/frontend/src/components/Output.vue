  ...
  <div class="h-full flex flex-col">
    ...
    >
      <div class="flex items-center gap-3">
        ...
        <span
          v-if="hasContent"
          class="text-xs text-emerald-400 bg-emerald-950 px-2 py-1 rounded"
        >
          {{ status }}
        </span>
      </div>
    ...
    <div class="flex-1 overflow-auto bg-[#0f172a]">
      <div v-if="!hasContent" class="h-full flex items-center justify-center">
        <div class="text-center">
          <div
            class="w-20 h-20 mx-auto mb-4 rounded-2xl bg-slate-800 flex items-center justify-center"
          >
            <svg
          ...
          <p class="text-lg text-slate-400 mb-2">
            El codigo Python aparecera aqui
          </p>
          <p class="text-sm text-slate-600">
            Ejecuta el analisis para ver resultados
          </p>
        </div>
      </div>
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 flex-1">
              ...
              <p class="text-red-400/80 text-sm mb-4">
                Se encontraron {{ errors.length }} error(es). No se puede
              ...
              <div class="space-y-3">
                ...
                >
                  <div class="flex justify-between items-start mb-2">
                    <span
                      class="font-mono text-sm font-bold text-red-400 bg-red-950/50 px-2 py-1 rounded"
                    >
                      '{{ error.char }}'
                    </span>
      ...
      <div v-else class="h-full p-6">
        <pre
          class="code-output text-sm text-slate-300"
    ...
    <!-- Footer -->
    <div
      class="bg-[#0f172a] border-t border-slate-700/50 px-5 py-2 text-xs text-slate-500 flex justify-between"
    >
